...
<head>
    ...
    <title>Counselling for Infertility | Fertility Counselling | Crysta Counsellor</title>
    <meta name="description" content=" Crysta provides fertility counselling to help individuals and couples. Our trained and experienced counselor gives you counselling for infertility and support in your fertility treatment.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/png" sizes="16x16" href="/favicon.ico">
    <meta name="msapplication-TileImage" content="/ms-icon-144x144.png">
    <meta name="theme-color" content="#003883">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link rel="canonical" href="https://crysta.care/fertility-counselling" />
...
<!--			<a class="redcliff-sponse"  target="_blank" href="https://www.redcliffels.com/"><img src="img/logos/rediclifff logo (1).png"></a>-->
    ...
    <div class="hero-text hero-text-fertility">
        <h1>Fertility<br>Counselling
        </h1>
...
<section class="coun-first">
    <div class="container">
        <div class="coun-first-text">
            <p>
                Around 15% of couples in the reproductive age worldwide have infertility related problems. Couples facing fertility problems tend to feel anxious and lonely. Any couple who are planning to have a baby but are not able to conceive after 1 year of trying, should see a fertility counsellor.</p>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="image-with-title">
                    ...
                    <div style="top: 50%;left: 32%;" class=" main-title title-box">
        ...
        <div class="row c-step-box">
            <div class="col-sm-6">
                <div class="c-g-box">
                    <div class="c-box-content">
                        <p>There are many underlying causes for infertility and we help you diagnose the root cause of your fertility problems</p>
                    </div>
                </div>
                <div class="c-g-box c-second">
                    <div class="c-box-content">
                        <p>Our extensive counselling sessions helps you deal with the emotional stress associated with inability to conceive</p>
                    </div>
                </div>
            ...
            <div class="col-sm-6 mobile-padding-box">
                <div class="c-g-box c-third">
                    <div class="c-box-content">
                        <p>The Crysta Fertility team will evaluate the couple and provide best personalized treatment suited to them for achieving a pregnancy.</p>
                    </div>
                </div>
                <div class="c-g-box c-four">
                    <div class="c-box-content">
                        <p>We guide you on the different options available to deal with concerns of conceiving</p>
                    </div>
                </div>
            </div>
        </div>
				...
				C103.8,46.1,102.4,45.8,100.9,45.8z"/>
                    ...
                    <div class="col-sm-9">
                        <div class="c-info">
                            ...
                            <p>To help couples plan ahead and seek personalised guidance to overcome their fertlity problems</p>
                        </div>
                    </div>
                </div>
				...
				c1.8,1.7,2,3.5,0.3,5.6c-9.5,12.4-21.1,22.3-35.4,28.9c-1.6,0.8-3.2,2-4.4,3.3C113.5,178,111.4,180.7,109,183.4z"/>
                    ...
                    <div class="col-sm-9">
                        <div class="c-info">
                            ...
                            <p>Ease of booking consultations with easy rescheduling. </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="accordion" class="accordion">
                    <div class="card mb-0">
                        <div class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                            <a class="card-title">
                                <p class="faqt"><span>1</span>What happens in a Crysta Fertility Counselling?</p>
                            </a>
                        </div>
                        <div id="collapseOne" class="card-body collapse show" data-parent="#accordion">
                            <p>A Crysta Fertility Counselling session is a safe place for couples to voice their concerns and anxieties related to infertility. We believe that an open discussion with a Fertility specialist not only helps understand the medical reasons behind the infertility but also helps reassure a couple that they are not alone in this journey. The Crysta Fertility team will evaluate the couple and provide best personalized treatment suited to them for achieving a pregnancy.</p>
                        </div>
                        <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                            <a class="card-title"><p class="faqt"><span>2</span>When should a couple see a Crysta Fertility Counsellor?</p></a>
                        </div>
                        <div id="collapseTwo" class="card-body collapse" data-parent="#accordion">
                            <p>Couples facing fertility problems tend to feel anxious and depressed which tends to affect every aspect of their lives. Any couple who are planning to have a baby but are not able to conceive after 1 year of trying should see a fertility counsellor. A Crysta fertility counsellor is someone who is trained in helping couples deal with this myriad of emotions which are associated to the inability to get pregnant. They also offer information regarding infertility, its causes and different options available to a couple facing this problem.</p>
                        </div>
                        <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                            <a class="card-title"><p class="faqt"><span>3</span>How do I book a Crysta Fertility Counselling session?</p></a>
                        </div>
                        <div id="collapseThree" class="collapse" data-parent="#accordion">
                            <div class="card-body"><p>A Fertility Counselling session can be booked through the online portal of Crysta’s website. You can go to the Services page and book a session from the available slots according to a time convenient to you. Crysta ensures patient-counsellor confidentiality and data privacy in every session.</p></div>
                        </div>
...
<section class="seo">
    <div class="container">
        ...
        <h5>Fertility Counselling</h5>
       <p> Most couples dream of having a baby and though it may seem simple, the process of conception and pregnancy is complicated. There are a number of factors which determine a successful pregnancy and many a times there may be a break in the chain of events which may lead to the inability to get pregnant.
        Fertility counselling can help all couples who have been trying to conceive for over 12 months and have not been successful in achieving a positive pregnancy result. It helps couples understand the underlying cause of the fertility problem and the various testing and management options which will help in a successful pregnancy.</p>
        </div>
        <div id="text" style="display: none;">
       <h5> What is infertility?</h5>
       <p> Infertility is the inability of a couple to conceive after 1 year of unprotected sexual intercourse. There may be many factors responsible for causing fertility problems:
           Infertility is also attached with a substantial amount of stigma and couples experiencing it often feel isolated and defeated. However, it is important for such couples to know that they are not alone in this journey. Infertility can be overcome by medication or certain procedures (like ART procedures). There are many options to consider which can help couples look forward to becoming parents in the future.</p>
        <h5> When should a couple see a Crysta Fertility Counsellor?</h5>
        <p>Around 15% of couples in the reproductive age worldwide have infertility related problems. Couples facing fertility problems tend to feel anxious and depressed, which affects every aspect of their lives. There is an attached sense of guilt and deficiency when a couple is unable to conceive. Any couple who is planning to have a baby but are not able to conceive after 1 year of trying, and who have abandoned all hope, should see a fertility counsellor. A Crysta fertility counsellor is someone who is trained in helping couples deal with this myriad of emotions which are associated with the inability to get pregnant. They also offer information regarding infertility, its causes and different options available to a couple facing this problem.</p>
        <h5>What happens in a Crysta Fertility Counselling session?</h5>
        <p>A Crysta Fertility Counselling session is a safe place for couples to voice their concerns regarding fertility and conception. A Fertility Counselor will review previous reports, family history and provide information regarding the fertility problem and possible options available for management, to the couple facing such problems. Fertility problems tend to weigh down on a couple who have been trying to have a baby. Crysta Fertility Counselling sessions help to understand the cause of the problem and how to plan ahead. The Crysta Fertility team will evaluate the couple and provide the best personalized treatment suited to them in getting pregnant.</p>
        <h5>Who should go for a Crysta Fertility Counselling Session?</h5>
       <p> Couples who have been trying to conceive for more than 12 months and have been unsuccessful should opt for a Fertility Counselling Session.
        Couples who have conceived but have not have carried the pregnancy to term, or have had miscarriages after being pregnant can also opt for a Fertility Counselling Session.
        Couples who have undergone a failed IUI or IVF cycle with implantation failure can also opt for a Fertility Counselling Session.</p>
        <p>Couples who have had a previous baby and are unable to conceive even after trying for 12 months can also opt for a Fertility Counselling Session.</p>
        <h5>How do I book a Crysta Fertility Counselling session?</h5>
       <p> A Fertility Counselling session can be booked through the online portal of Crysta’s website. You can go to the ‘Book Now’ page and book a session from the available slots according to a time convenient to you. Crysta ensures patient-counsellor confidentiality and data privacy in every session.</p>
        <h5>What next after a Fertility Counselling Session?</h5>
        <p>A Fertility Counselling Session helps couples understand the cause of the fertility problem. After this session, the couple is guided to a Crysta Fertility Specialist who will further evaluate them and provide the best personalised treatment for the couple to achieve a successful pregnancy. Crysta provides the best in Fertility with renowned fertility specialists on panel, routine and advanced fertility testing and counselling services for couples to manage and prepare for a pregnancy.  All these services are available through an online module that allows easy accessibility to all couples.</p>
        </div>
