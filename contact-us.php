...
<head>
    ...
    <title>Contact Us - Crysta Pregnancy Care</title>
    <meta name="description" content="Crysta - Please feel free to contact us if you have any query regarding preganancy and fertility care.Please fill the foem , email us or call at our helpline number to get in touch with us.">
...
<section class="c-contact">
    <div class="container">
        ...
        <div class="row c-for-u-box-contact">
            <div class="col-md-6">
                <div class="main-title-contact">
                    <h1>Care<br>@Crysta</h1>
                </div>
                <div class="step-image-contact"> <img src="/img/Contact-Us-page.png" alt="Cysta Cares"></div>

            </div>
            <div class="col-md-6">
                <div class="col-xs-12 col-sm-12">
                    <div class="page-index-contact__section-container-1">
                        <div clsas="u-text-darkest">
                            <p class="page-index-contact__description-1">
                                Crysta cares for you! Pop by for any queries, reach out to us at:
                            </p></div>
                            <div clsas="u-text-darkest">
                            <p class="page-index-contact__description-1">
                                Fertility inquiries:<br>
                                care@redcliffels.com

                            </p>
                        </div>
                            <div clsas="u-text-darkest">
                            <p class="page-index-contact__description-2">
                                Helpline number:<br>
                                18001213327
                            </p> </div>
                        <div clsas="u-text-darkest">
                            <p class="page-index-contact__description-1">
                                Address: <br>Redcliffe Life Science Pvt. Ltd. H-55,<br>
                                Sector-63, Electronic City, Noida, Uttar Pradesh,<br>
                                Pincode: 201301
                            </p></div>
...
<section class="contact-new">
    <div class="container contact-box contact-main-page">
