...
$con = mysqli_connect("localhost","qprgjmajdd","hbm2YFApCn") or die('Could not connect: ' . mysqli_error());



mysqli_select_db("qprgjmajdd", $con);




if(mysqli_query("INSERT INTO omaxe_r2(username,user_email,mobile,subject,message,about,appointdate,sex,child,status,date) VALUES ('".$_POST['username']."', '".$_POST['user_email']."','".$_POST['mobile']."','".$_POST['subject']."','".$_POST['message']."','".$_POST['about']."','".$_POST['appointdate']."','".$_POST['sex']."','".$_POST['child']."','1','".date('F jS, Y')."')")) {
